...
import UIKit
//MARK: Set your image picker's delegate property to self. If your view controller doesn't conform to the UINavigationControllerDelegate and UIImagePickerControllerDelegate protocols, you'll get an error at this point. You can fix the error by adding these protocols to the class declaration.
